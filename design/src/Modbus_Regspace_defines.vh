...
`define CHKMEM_A0_MASK              16'b1011_1111_100?_????, 16'b1011_1111_101?_????, 16'b1011_1111_110?_????
`define CHKMEM_SHD_MASK             16'b1011_1111_1110_00??
// ACTMEM space
...
`define TEST_DONE_BP 8
`define TEST_RUNNING_BP 7
`define A0_RUNNING_BP 6
`define CT_RUNNING_BP 5
`define CM_RUNNING_BP 4
...
`define MEMSEL_A0_MASK 12'b1111_1100_????, 12'b1111_1101_????, 12'b1111_1110_????
`define MEMSEL_SHD_MASK 12'b1111_1111_000?
...
`define MEMSEL_CT_MASK_END 12'hf8f
`define MEMSEL_A0_MASK_START 12'hfc0
`define MEMSEL_A0_MASK_END 12'hfef
`define MEMSEL_SHD_MASK_START 12'hff0
`define MEMSEL_SHD_MASK_END 12'hff1
